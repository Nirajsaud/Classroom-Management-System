    ...
    <footer class="footer">
        <div class="container footer-grid">
            <div class="footer-brand">
                <span class="logo">pathshala</span>
                <p class="footer-tagline">Bridging school education with the digital world.</p>
            ...
            <div class="footer-links">
                <h4>Let's Connect</h4>
                <p><i class="fa-solid fa-envelope"></i> help.pathshala@gmail.com</p>
                <p><i class="fa-solid fa-phone"></i> +977 9841221122</p>
            </div>
        </div>
        <div class="footer-bottom">
            <p>&copy; pathshala — Nepal 2026. Built with care for students everywhere.</p>
        </div>
    </footer>
