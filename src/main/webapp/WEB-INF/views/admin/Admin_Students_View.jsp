    ...
    <div class="main-area">
        <header class="topbar">
            <div class="bell-wrapper" id="bellWrapper">
                <button class="bell-btn" id="bellBtn" title="Notifications">
                    <svg class="bell-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg>
                </button>
            </div>
        ...
        <main class="content-area">
            <div class="form-header">
                <a href="${pageContext.request.contextPath}/students" class="btn-cancel">Back to Directory</a>
            ...
            <div class="student-details-container">
                <div class="student-details-left">
                    ...
                    <div class="student-form-group">
                        ...
                        <input type="text" value="<c:out value="${studentDetail.fullName}"/>" readonly>
                    </div>
                    <div class="student-form-group">
                        <label>EMAIL</label>
                        <input type="email" value="<c:out value="${studentDetail.email}"/>" readonly>
                    </div>
                    <div class="student-form-group">
                        <label>PHONE NUMBER</label>
                        <input type="text" value="<c:out value="${studentDetail.phoneNumber}"/>" readonly>
                    </div>
                </div>

                <div class="student-details-right">
                    <div class="enrolled-classroom-header">Enrolled Classrooms</div>
                    <div class="enrolled-classroom-list">
                        <c:forEach var="classroom" items="${classroomArr}">
                            <div class="classroom-item"><c:out value="${classroom}"/></div>
                        </c:forEach>
                    </div>
                    <div class="last-login-badge">Account Created : <c:out value="${studentDetail.registeredDate}"/></div>
                </div>
            </div>
        </main>
    </div>
</div>
<script src="${pageContext.request.contextPath}/js/Admin_Students_View.js"></script>
</body>
</html>